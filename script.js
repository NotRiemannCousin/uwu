...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    ...
    h = ['<ul><li>handa-kun', '</li><li>hauru no ugoku shiro', '</li><li>her blue sky', '</li><li>hinamatsuri', '</li><li>hitori bocchi no marumaru seikatsu', '</li><li>hoshi wo ou kodomo', '</li><li>hotaru no haka', '</li><li>hotarubi no mori e', '</li><li>houkago teibou nisshi', '</li><li>hourou musuko</li></ul>']; h1 = h.length;
