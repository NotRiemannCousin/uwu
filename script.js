...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    ...
    filmes = ['<ul><li>bakemono no ko', '</li><li>byousoku 5 senchimetoru', '</li><li>fireworks', '</li><li>hauru no ugoku shiro', '</li><li>her blue sky', '</li><li>hotaru no haka', '</li><li>hotarubi no mori e', '</li><li>kime no suizou wo tabetai', '</li><li>kimi no na wa', '</li><li>kimi to, nami ni noretara', '</li><li>koe no katachi', '</li><li>kokoro ga sakebitagatterunda', '</li><li>mononoke hime', '</li><li>nakitai watashi wa neko wo kaburu', '</li><li>ookami kodomo no ame to yuki', '</li><li>sen to chihiro no kamikakushi', '</li><li>toki wo kakeru shoujo', '</li><li>weathering with you</li></ul>']; filmes1 = filmes.length //Os filmes e sua quant.
}
