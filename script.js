...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    a = ['<ul><li>afro samurai', '</li><li>aho girl', '</li><li>akame ga kill', '</li><li>akashic records', '</li><li>akkun to kanojo', '</li><li>alice to zouroku', '</li><li>angel beats!', '</li><li>anohana', '</li><li>another', '</li><li>arakawa under the bridge', '</li><li>asobi asobase</li></ul>']; a1 = a.length;
    ...
    d = ['<ul><li>d-frag!', '</li><li>danshi koukousei no nichijou', '</li><li>death note', '</li><li>death parade', '</li><li>devilman crybaby', '</li><li>diabolik lovers', '</li><li>dorohedoro</li></ul>']; d1 = d.length;
    e = ['<ul><li>elfen lied</li></ul>']; e1 = e.length;
    f = ['<ul><li>fireworks', '</li><li>flying witch</li></ul>']; f1 = f.length;
    g = ['<ul><li>given', '</li><li>golden boy</li></ul>']; g1 = g.length;
    h = ['<ul><li>hanayamata','</li><li>handa-kun', '</li><li>hauru no ugoku shiro', '</li><li>her blue sky', '</li><li>hinamatsuri', '</li><li>hitori bocchi no marumaru seikatsu', '</li><li>hoshi wo ou kodomo', '</li><li>hotaru no haka', '</li><li>hotarubi no mori e', '</li><li>houkago teibou nisshi', '</li><li>hourou musuko</li></ul>']; h1 = h.length;
    i = ['<ul><li>ijiranaide nagatoro-san', '</li><li>inuyashiki', '</li><li>ito junji: collection</li></ul>']; i1 = i.length;
    j = ['<ul><li>jibaku shounen hanako-kun</li></ul>']; j1 = j.length;
    k = ['<ul><li>kaguya sama', '</li><li>kakegurui', '</li><li>keppeki danshi! aoyama-kun', '</li><li>kill me baby', '</li><li>kime no suizou wo tabetai', '</li><li>kimetsu no yaiba', '</li><li>kimi no na wa', '</li><li>kimi to, nami ni noretara', '</li><li>kiseijuu (parasyte)', '</li><li>kiss him, not me', '</li><li>koe no katachi', '</li><li>koi to uso', '</li><li>kokoro connect', '</li><li>kokoro ga sakebitagatterunda', '</li><li>konosuba', '</li><li>kyoukai no kanata</li></ul>']; k1 = k.length;
    l = ['<ul><li>little witch academia</li></ul>']; l1 = l.length;
    m = ['<ul><li>maquia: when the promised flower blooms', '</li><li>mononoke hime', '</li><li>my roommate is a cat</li></ul>']; m1 = m.length;
    ...
    p = ['<ul><li>perfect blue', '</li><li>plastic memories', '</li><li>poputepipikku</li></ul>']; p1 = p.length;
    q = ['<ul><li>. . .</li></ul>']; q1 = 0;
    r = ['<ul><li>. . .</li></ul>']; r1 = 0;
    s = ['<ul><li>sakamoto desu ga?', '</li><li>sen to chihiro no kamikakushi', '</li><li>shigatsu wa kimi no uso', '</li><li>shimoneta', '</li><li>sword art online</li></ul>']; s1 = s.length;
    t = ['<ul><li>tari tari', '</li><li>to be hero', '</li><li>toki wo kakeru shoujo', '</li><li>tokyo magnitude 8.0', '</li><li>tonari no kaibutsu-kun', '</li><li>tonari no seki-kun', '</li><li>tonari no totoro', '</li><li>tonikaku kawaii</li></ul>']; t1 = t.length;
    u = ['<ul><li>. . .</li></ul>']; u1 = 0;
    ...
    animes = ['<ul><li>afro samurai', '</li><li>aho girl', '</li><li>akame ga kill', '</li><li>akashic records', '</li><li>akkun to kanojo', '</li><li>alice to zouroku', '</li><li>angel beats!', '</li><li>anohana', '</li><li>another', '</li><li>arakawa under the bridge', '</li><li>asobi asobase', '</li><li>baccano!', '</li><li>banana fish', '</li><li>barakamon', '</li><li>beastars s1', '</li><li>black★rock shooter', '</li><li>blend-s', '</li><li>blood c', '</li><li>bloom into you', '</li><li>boku dake ga inai machi (erased)', '</li><li>boku wa tomodachi ga sukunai', '</li><li>bunny girl', '</li><li>charlotte', '</li><li>classroom of the elite', '</li><li>d-frag!', '</li><li>danshi koukousei no nichijou', '</li><li>death note', '</li><li>death parade', '</li><li>devilman crybaby', '</li><li>diabolik lovers', '</li><li>dorohedoro', '</li><li>elfen lied', '</li><li>given', '</li><li>flying witch', '</li><li>golden boy', '</li><li>hanayamata', '</li><li>handa-kun', '</li><li>hinamatsuri', '</li><li>hitori bocchi no marumaru seikatsu', '</li><li>houkago teibou nisshi', '</li><li>hourou musuko', '</li><li>ijiranaide nagatoro-san', '</li><li>inuyashiki', '</li><li>ito junji: collection', '</li><li>jibaku shounen hanako-kun', '</li><li>kaguya sama', '</li><li>kakegurui', '</li><li>keppeki danshi! aoyama-kun', '</li><li>kill me baby', '</li><li>kimetsu no yaiba', '</li><li>kiseijuu (parasyte)', '</li><li>kiss him, not me', '</li><li>koi to uso', '</li><li>kokoro connect', '</li><li>konosuba', '</li><li>kyoukai no kanata', '</li><li>little witch academia', '</li><li>my roommate is a cat', '</li><li>nanatsu no taizai', '</li><li>naruto classic', '</li><li>nichijou', '</li><li>no.6', '</li><li>noblesse', '</li><li>one punch man', '</li><li>ore monogatari!!', '</li><li>orange', '</li><li>oregairu', '</li><li>osake wa fuufu ni natte kara', '</li><li>oshiete! galko-chan', '</li><li>plastic memories', '</li><li>poputepipikku', '</li><li>sakamoto desu ga?', '</li><li>shigatsu wa kimi no uso', '</li><li>shimoneta', '</li><li>sword art online', '</li><li>tari tari', '</li><li>to be hero', '</li><li>tokyo magnitude 8.0', '</li><li>tonari no kaibutsu-kun', '</li><li>tonari no seki-kun', '</li><li>tonikaku kawaii', '</li><li>violet evergarden', '</li><li>yakusoku no neverland', '</li><li>yuri on ice', '</li><li>zankyou no terror</li></ul>']  //Os animes
    animes1 = animes.length //Quant. de animes
    filmes = ['<ul><li>bakemono no ko', '</li><li>byousoku 5 senchimetoru', '</li><li>fireworks', '</li><li>hauru no ugoku shiro', '</li><li>her blue sky', '</li><li>hoshi wo ou kodomo', '</li><li>hotaru no haka', '</li><li>hotarubi no mori e', '</li><li>kime no suizou wo tabetai', '</li><li>kimi no na wa', '</li><li>kimi to, nami ni noretara', '</li><li>koe no katachi', '</li><li>kokoro ga sakebitagatterunda', '</li><li>maquia: when the promised flower blooms', '</li><li>mononoke hime', '</li><li>nakitai watashi wa neko wo kaburu', '</li><li>ookami kodomo no ame to yuki', '</li><li>perfect blue', '</li><li>sen to chihiro no kamikakushi', '</li><li>toki wo kakeru shoujo', '</li><li>tonari no totoro', '</li><li>weathering with you</li></ul>']; filmes1 = filmes.length //Os filmes e sua quant.
}
